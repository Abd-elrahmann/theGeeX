  ...
  return (
    ...
    >
      ...
      >
        ...
        {project.description ? (
          <p className="mx-auto mt-(--projects-page-card-description-margin-top) mb-0 hidden w-full max-w-(--projects-card-content-max-width) shrink-0 whitespace-pre-wrap wrap-break-word font-poppins text-(length:--projects-page-card-description-size) leading-(--projects-page-card-description-line-height) font-normal tracking-normal text-(--color-project-card-foreground) font-features-normal md:block">
            {project.description}
          </p>
        ) : null}
