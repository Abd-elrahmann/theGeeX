  ...
  return (
    <div
      className={cn(
        ...
        isDesktop
          ? "gap-(--storytelling-gap) p-(--storytelling-content-padding) flex-row flex-nowrap items-center justify-center overflow-visible max-lg:min-w-0 max-lg:w-fit max-lg:max-w-full max-lg:overflow-hidden max-lg:p-0"
